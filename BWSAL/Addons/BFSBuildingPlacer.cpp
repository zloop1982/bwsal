...
void BFSBuildingPlacer::onAttach(TaskStream* ts)
{
  /*
...
void BFSBuildingPlacer::onDetach(TaskStream* ts)
{
  taskStreamData.erase(ts);
}
void BFSBuildingPlacer::onNewStatus(TaskStream* ts)
{
}
void BFSBuildingPlacer::onCompletedTask(TaskStream* ts, WorkBench* wb, const Task &t)
{
...
void BFSBuildingPlacer::onFrame(TaskStream* ts)
{
  /*
  for each(WorkBench* wb in ts->workBenches)
  {
